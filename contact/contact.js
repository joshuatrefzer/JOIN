...
function overlayAddContact() {
  ...
  document.querySelector('.overlayAddContact').classList.remove('d-none');
  setTimeout(() => {
...
/**
 * shows edit popup, removes classes for the come - in animation
 */
function showEditPopup() {
  document.getElementById('popUpContainer').classList.remove('d-none');
  document.getElementById('overlayEditContact').classList.remove('d-none');
  setTimeout(() => {
