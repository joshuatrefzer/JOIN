...
function checkForm() {
    if (!titleField.value) {
        document.getElementById('validateTitle').classList.add('redText');
    } else {
        document.getElementById('validateTitle').classList.remove('redText');
    } if (!descriptionField.value) {
        document.getElementById('validateDescription').classList.add('redText');
    } else {
        document.getElementById('validateDescription').classList.remove('redText');
    } if (!dueDateField.value) {
        document.getElementById('validateDueDate').classList.add('redText');
    } else {
        document.getElementById('validateDueDate').classList.remove('redText');
    } if (priorityClicked == 'unclicked') {
        document.getElementById('validatePrio').classList.add('redText');
    } else {
        document.getElementById('validatePrio').classList.remove('redText');
    } if (assignedContacts.length > 0) {
        document.getElementById('validateAssigned').classList.remove('redText');
    } else {
        document.getElementById('validateAssigned').classList.add('redText');
    } if (newCat == 1) {
        document.getElementById('validateCategory').innerHTML = "Please enter category and choose color!"
        document.getElementById('validateCategory').classList.add('redText');
    } else {
